...
class Wam(nn.Module):
    ...
    def embed(
        ...
        inverse_resize = torch.compiler.disable(inverse_resize)
    ...
    def detect(
        ...
        resize = torch.compiler.disable(resize)
...
if __name__ == "__main__":
    ...
    from watermark_anything.modules.vae import VAEDecoder, VAEEncoder
